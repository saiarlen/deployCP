...
func (a *Application) registerRoutes() {
	...
	secured.Get("/websites/:id/manage/database/:dbid/adminer", a.WebsiteHandler.ManageAdminerDB)
	...
	secured.Get("/apps/:id/manage/database/:dbid/adminer", a.AppHandler.ManageAdminerDB)
