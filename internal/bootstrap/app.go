...
func (a *Application) registerRoutes() {
	...
	secured.All("/websites/:id/manage/database/:dbid/postgres-gui", a.WebsiteHandler.ManageOpenPostgresGUI)
	...
	secured.All("/apps/:id/manage/database/:dbid/postgres-gui", a.AppHandler.ManageOpenPostgresGUI)
